...
func (c *ChromeCSS) SetPropertyText(styleSheetId *types.ChromeCSSStyleSheetId, range *types.ChromeCSSSourceRange, text string, ) (*types.ChromeCSSCSSStyle, error) {
	paramRequest := make(map[string]interface{}, 3)
	paramRequest["styleSheetId"] = styleSheetId
	paramRequest["range"] = range
	paramRequest["text"] = text
...
func (c *ChromeCSS) SetRuleSelector(styleSheetId *types.ChromeCSSStyleSheetId, range *types.ChromeCSSSourceRange, selector string, ) (*types.ChromeCSSCSSRule, error) {
	paramRequest := make(map[string]interface{}, 3)
	paramRequest["styleSheetId"] = styleSheetId
	paramRequest["range"] = range
