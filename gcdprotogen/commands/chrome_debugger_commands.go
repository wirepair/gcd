...
// Async stack trace, if any.
func (c *ChromeDebugger) SetScriptSource(scriptId *types.ChromeDebuggerScriptId, scriptSource string, preview bool, ) ([]*types.ChromeDebuggerCallFrame, object, *types.ChromeDebuggerStackTrace, error) {
...
// Async stack trace, if any.
func (c *ChromeDebugger) RestartFrame(callFrameId *types.ChromeDebuggerCallFrameId, ) ([]*types.ChromeDebuggerCallFrame, object, *types.ChromeDebuggerStackTrace, error) {
	paramRequest := make(map[string]interface{}, 1)
	paramRequest["callFrameId"] = callFrameId
