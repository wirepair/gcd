...
func (c *ChromeLayerTree) CompositingReasons(layerId *types.ChromeLayerTreeLayerId, ) ([]types.string, error) {
	paramRequest := make(map[string]interface{}, 1)
	...
	var chromeData struct {
		Result struct { 
			CompositingReasons []types.string 
		}
	}
...
func (c *ChromeLayerTree) SnapshotCommandLog(snapshotId *types.ChromeLayerTreeSnapshotId, ) ([]types.object, error) {
	paramRequest := make(map[string]interface{}, 1)
	paramRequest["snapshotId"] = snapshotId
