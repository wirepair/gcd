...
type BackgroundServiceBackgroundServiceEvent struct {
	...
	Service                     string                            `json:"service"`                     // The Background Service this event belongs to. enum values: backgroundFetch, backgroundSync
...
type BackgroundServiceRecordingStateChangedEvent struct {
	...
	Params struct {
		...
		Service     string `json:"service"`     //  enum values: backgroundFetch, backgroundSync
...
type BackgroundServiceStartObservingParams struct {
	//  enum values: backgroundFetch, backgroundSync
...
// service -  enum values: backgroundFetch, backgroundSync
