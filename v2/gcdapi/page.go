...
type PageFrameSubtreeWillBeDetachedEvent struct {
	Method string `json:"method"`
	Params struct {
		FrameId string `json:"frameId"` // Id of the frame that is the root of the subtree that will be detached.
	} `json:"Params,omitempty"`
}
