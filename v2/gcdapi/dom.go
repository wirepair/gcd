...
type DOMScrollableFlagUpdatedEvent struct {
	Method string `json:"method"`
	Params struct {
		NodeId       int  `json:"nodeId"`       // The id of the node.
